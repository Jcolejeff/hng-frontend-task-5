export const faqQA = [
	...
	},
	{
		...
		answer:
			"A well written cv stands out when you expand on your resume,customize your letter to the specific job,show your personality. Also by writing concisely, being professional and making sure to edit before submitting.",
	},
	{
		id: 4,
		question: "Why should I use the Aplicar cover letter generator?",
		answer:
			"The Aplicar cover letter generator is a convenient and easy to use model with multiple template options and an up to date design. Apart from being free, it creates your new cover letter in less than 5 minutes. Not to mention the assortment of templates and fonts, colors and designs.",
	},
	{
		id: 5,
		question: "Does the Aplicar cover letter generator save my cv?",
		answer:
			"Your cover letter is available for download immediately after editing and generating. You can choose the format you want your cover letter in (eg. PDF, Word, JPEG, or SVG.)",
	},
	{
		id: 6,
		question: "How should my cover letter complement my resume?",
		answer:
			"The point of a cover letter is to provide more details about what’s in your resume as well as show the recruiter how motivated you are to join their team. A cover letter should therefore be written based on the jobs, tasks, achievements, and skills that are on your resume.",
	},
	{
		id: 7,
		question: "Is Aplicar’s cover letter generator free?",
		answer:
			"You can use Aplicar Cover Letter Generator for free to generate cover letters, resumes, and CVs.",
	},
	{
		id: 8,
		question: "Are cover letters really necessary?",
		answer:
			"In most situations, yes — cover letters are still necessary. Unless the job description specifically says to not include a cover letter, attaching a cover letter to your application won’t hurt your chances of getting called for an interview, and will likely increase your chances.",
	},
	{
		id: 9,
	...
	},
	{
		...
		answer:
			"The standard cover letter is in business letter format, which means it should be a readable font size, one-inch margins all the way around, and one page double spaced.",
	},
];
export const links = [
	{
